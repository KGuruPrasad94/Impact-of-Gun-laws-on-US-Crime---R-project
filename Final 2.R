...
#fixed effects with time and entity fixed effects
...
random_vio3 <- plm(log(vio)~shall+log(incarc_rate)+pb1064+pm1029+pw1064+pop+avginc+factor(year)-1, data=guns2, model="random")
summary(random_vio3)
